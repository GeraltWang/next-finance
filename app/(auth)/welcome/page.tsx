...
import { useGetUserSyncStatus } from '@/features/auth/api/use-get-user-sync-status'

const WelcomePage = () => {
	const router = useRouter()

	const { data } = useGetUserSyncStatus()
	...
	return (
		<div className='flex min-h-screen w-full items-center justify-center px-4'>
			...
			<div className='relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center'>
				...
				<h1 className='text-pretty text-4xl font-semibold tracking-tight text-zinc-800 sm:text-5xl'>
